...
Simpliest open_load() returns non-null pointer - it's enough to report 'o.k'
...
explain the error, otherwise user gets common "Loading error"
...
codec calls some Prima code with issues croak(). This condition 
...
this functionality is under design. It's current value
