...
=item onMeasure WIDGET, MENUITEM, REF
...
=item onPaint WIDGET, MENUITEM, CANVAS, SELECTED, X1, Y1, X2, Y2
...
Manages autoToggle flag for a menu item. When set, C<checked> option
is flipped when user selects the item.
