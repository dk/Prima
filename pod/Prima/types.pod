...
Auxillary second-citizen classes that are not usually created manually but used
...
Named accessor properties for the 6 members.
...
Applies inverse matrix tranformation to an array or arrayref of points,
...
Applies matrix tranformation to an array or arrayref of points,
and returns in the same format (i e array for array, ref for ref).
