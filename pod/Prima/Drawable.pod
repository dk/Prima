...
to a C<Prima::matrix> object return by C<get_matrix>, is a direct accessor to the drawable's
matrix:
...
=item rect_and_bar X1, Y1, X2, Y2, FOREGROUND, BACKGROUND, BORDER_WIDTH
