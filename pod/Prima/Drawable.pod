...
and Prima::Printer are backed by OS-dependent routines
...
This function can be unsuccessfull, because the object binds with OS resources
...
glyph if it's index is passed to the text drawing routines.
...
Set to -1 if no ~ - escapement was found. 
