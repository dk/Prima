...
action at any given moment the use chose, by responding to a C<DragQuery>
...
=item MenuItemMeasure MENU, ITEMID, REF
...
See also: L<Prima::Menu/Options>

=item MenuItemPaint WIDGET, MENU, ITEMID, CANVAS, SELECTED, X1, Y1, X2, Y2
