...
properties scheme, the tookit uses methods instead.
...
in the tookit a widget without a parent still does have a valid owner.
...
=item helpContext INTEGER

I<Design in progress>. A positive integer value, that binds a
widget, a logical part it plays with the application
and an interactive help topic. As well as positive integers,
the following constants can be used: 

   hmp::None       no topic
   hmp::Owner      same topic as owner's
   hmp::Main       the main or startup entry 
   hmp::Contents   the contents or index entry
   hmp::Extra      user-defined, supplementary entry
...
Maintains the eight color properties of a pop-up context menu,
...
Basic foreground popup context menu color.

See also: C<popupItems>, C<popupColorIndex>, C<popupFont>, C<popup>

=item popupBackColor COLOR

Basic background popup context menu color.

See also: C<popupItems>, C<popupColorIndex>, C<popupFont>, C<popup>

=item popupDark3DColor COLOR

Color for drawing dark shadings in popup context menu color.

See also: C<popupItems>, C<popupColorIndex>, C<popupFont>, C<popup>

=item popupDisabledColor COLOR

Foreground color for disabled items in popup context menu color. 

See also: C<popupItems>, C<popupColorIndex>, C<popupFont>, C<popup>

=item popupDisabledBackColor COLOR

Background color for disabled items in popup context menu color. 
...
Foreground color for selected items in popup context menu color. 

See also: C<popupItems>, C<popupColorIndex>, C<popupFont>, C<popup>

=item popupHiliteBackColor COLOR

Background color for selected items in popup context menu color. 
...
Color for drawing light shadings in popup context menu color.
...
I<Design in progress>. Supposed to start an interactive
help program, opened on C<::helpContext> property value.
...
I<Design in progress>. Called when the user presses 
a system-defined key combination, used for interactive
help invocation. Usually the key is kb::F1.
