...
currently implemented Tk managers are grid (C<gt::Grid>), packer ( C<gt::Pack>
) and placer ( C<gt::Place>).  Each has its own set of options and methods, and
their manuals are provided separately in L<Prima::Widget::grid>,
L<Prima::Widget::pack> and L<Prima::Widget::place> ( the manpages are also
imported from the Tk ).
...
See C<growMode>, L<Prima::Widget::grid>, L<Prima::Widget::pack>, L<Prima::Widget::place>.
...
The hint back color for the widget

See also: C<ownerHintBackColor>

=item hintColor COLOR

The hint color for the widget

See also: C<ownerHintColor>
...
=item ownerHintBackColor BOOLEAN

If 1, the hint color is synchronized with the owner's.
Automatically resets to 0 if the C<::hintBackColor> property is set explicitly.

See also: C<hintBackColor>

=item ownerHintColor BOOLEAN

If 1, the hint color is synchronized with the owner's.
Automatically resets to 0 if the C<::hintColor> property is set explicitly.

See also: C<hintColor>
...
=item gridConfigure, gridBbox, etc

gridConfigure, gridBbox, gridInfo, gridLocation, gridColConfigure,
gridRowConfigure, gridPropagate, gridSize, gridSlaves, gridForget, gridRemove,
gridLock, gridUnlock, gridIsLocked

See L<Prima::Widget::grid>
