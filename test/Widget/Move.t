print "1..7 onMove message - pass 1,parameters consistency - pass 1,child move,child move consistency,onMove message - pass 2,parameters consistency - pass 2,gmDontCare\n";
...
ok( $mrep[0] == $or[0] && $mrep[1] == $or[1] && $mrep[2] == $mrep[0] + 1 && $mrep[3] == $mrep[1] + 1);
ok( scalar(@mrep2));
