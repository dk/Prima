...
is( $i-> pixel( 0,0), 0, "pixel" );
is( $i-> pixel( 15,15), 0, "pixel" );
isnt( $i-> pixel( 1,1), 0, "pixel" );
$i-> begin_paint;
...
$i-> size( 160, 160);
# 11, 12, 13
is( $i-> pixel( 0,0), 0, "stretch" );
is( $i-> pixel( 159,159), 0, "stretch" );
$i-> size( 16, 16);
$i-> pixel( 15, 15, 0xFFFFFF);
isnt( $i-> pixel( 15,15), 0, "pixel bpp1" );
$i-> size( -16, -16);
isnt( $i-> pixel( 0,0), 0, "reverse stretch" );
is( $i-> pixel( 15,15), 0, "reverse stretch" );
...
is( $i-> pixel( 0, 0), 255, "offline put_image" );
is( $i-> pixel( 0, 0), 255, "offline put_image" );
is( $i-> pixel( 0, 1), 255, "offline put_image" );
is( $i-> pixel( 1, 0), 255, "offline put_image" );
is( $i-> pixel( 1, 1), 254, "offline put_image" );
