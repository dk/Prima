...
int DGifGetImageDesc(GifFileType *GifFile)
{
    ...
    if (GifFile->Image.ColorMap != NULL) {
	    ...
	    sp->ImageDesc.ColorMap->Colors =
               (GifColorType *)malloc(sizeof (GifColorType) * GifFile->Image.ColorMap->ColorCount);
	    memcpy(sp->ImageDesc.ColorMap->Colors,
               GifFile->Image.ColorMap->Colors, sizeof(GifColorType) * GifFile->Image.ColorMap->ColorCount);
    }
